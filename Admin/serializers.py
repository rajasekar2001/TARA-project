...
class AdminSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'company_name', 'password', 'status', 'dob', 'gender',
    ...
    def generate_user_code(self):
        """
        Generate user_code with AD prefix for Admin.
        """
        prefix = "AD"  # Fixed prefix for Admin
        last_user = Admin.objects.filter(user_code__startswith=prefix + "-").order_by('-user_code').first()
    ...
    def create(self, validated_data):
        """
        Create Admin user with auto-generated user_code.
        """
        # Generate user code with AD prefix
