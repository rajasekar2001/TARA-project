...
class Admin(AbstractUser):
    ...
    groups = models.ManyToManyField(Group, related_name="Admin", blank=True)
    user_permissions = models.ManyToManyField(Permission, related_name="Admin", blank=True)
...
models.signals.pre_save.connect(fetch_location_pre_save, sender=Admin)


def save(self, *args, **kwargs):
        if Admin.objects.filter(user_code=self.user_code).exists():
