    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile_no', models.CharField(blank=True, max_length=15, null=True, validators=[SuperAdmin.models.validate_mobile_no])),
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='SuperAdmin', to='auth.group')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='SuperAdmin', to='auth.permission')),
            ],
            options={
                'verbose_name': 'user',
