# Generated by Django 5.1.5 on 2025-04-08 04:09

import Craftsman.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile_no', models.CharField(blank=True, max_length=15, null=True, validators=[Craftsman.models.validate_mobile_no])),
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='craftman_users', to='auth.group')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='craftman_users', to='auth.permission')),
            ],
            options={
                'verbose_name': 'user',
