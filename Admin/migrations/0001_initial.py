# Generated by Django 5.1.5 on 2025-04-08 06:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile_no', models.CharField(blank=True, max_length=15, null=True, validators=[Admin.models.validate_mobile_no])),
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='Admin', to='auth.group')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='Admin', to='auth.permission')),
            ],
            options={
                'verbose_name': 'user',
