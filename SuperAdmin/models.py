...
class SuperAdmin(AbstractUser):
    ...
    groups = models.ManyToManyField(Group, related_name="SuperAdmin", blank=True)
    user_permissions = models.ManyToManyField(Permission, related_name="SuperAdmin", blank=True)
...
models.signals.pre_save.connect(fetch_location_pre_save, sender=SuperAdmin)


def save(self, *args, **kwargs):
        if SuperAdmin.objects.filter(user_code=self.user_code).exists():
