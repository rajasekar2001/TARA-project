...
class SuperAdminSerializer(serializers.ModelSerializer):
    ...
    def generate_user_code(self):
        """
        Generate user_code with SA prefix for SuperAdmin.
        """
        prefix = "SA"  # Fixed prefix for SuperAdmin
        last_user = SuperAdmin.objects.filter(user_code__startswith=prefix + "-").order_by('-user_code').first()
    ...
    def create(self, validated_data):
        ...
        """
        # Generate user code with SA prefix
