...
class KeyUsers(AbstractUser):
    ...
    groups = models.ManyToManyField(Group, related_name="KeyUsers", blank=True)
    user_permissions = models.ManyToManyField(Permission, related_name="KeyUsers", blank=True)
...
models.signals.pre_save.connect(fetch_location_pre_save, sender=KeyUsers)


def save(self, *args, **kwargs):
        if KeyUsers.objects.filter(user_code=self.user_code).exists():
