...
class Order(models.Model):
    ...
    craftsman = models.ForeignKey(ResUser, on_delete=models.SET_NULL, null=True, blank=True, related_name='assigned_orders')
    ...
    craftsman = models.ForeignKey(ResUser, null=True, blank=True, on_delete=models.SET_NULL, related_name='assigned_orders')
